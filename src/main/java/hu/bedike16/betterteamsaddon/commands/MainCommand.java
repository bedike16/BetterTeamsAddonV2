package hu.bedike16.betterteamsaddon.commands;

import hu.bedike16.betterteamsaddon.Main;
import hu.bedike16.betterteamsaddon.commands.argumentMatchers.ArgumentMatcher;
import hu.bedike16.betterteamsaddon.messages.ComponentUtil;
...
public abstract class MainCommand implements TabExecutor {
    ...
    public MainCommand(String noPermissionMessage, ArgumentMatcher argumentMatcher) {
        this.noPermMessage = ComponentUtil.formatToComponent(noPermissionMessage);
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (sender.hasPermission(subCommand.getPermission()) || sender.isOp())
            ...
            Main.getInstance().adventure().sender(sender).sendMessage(noPermMessage);
    ...
    public void registerMainCommand(JavaPlugin main, String cmdName) {
        ...
        cmd.setPermissionMessage(ComponentUtil.formatToString(noPermMessage));
    }
